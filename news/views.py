...
class NewsUpdateView(View):
    def get(self, request):
        # Run makemigrations and migrate (⚠️ DEV ONLY)
        subprocess.run(["python", "manage.py", "makemigrations", "news"])
        ...
        return HttpResponse(f"News update completed. {total_added} new items added.")
